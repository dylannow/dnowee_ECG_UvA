...
threshold = 0.11985953479190482 # found with platt scaling
...
def create_model():
    ...
    # Replace first conv layer: Conv2d(3, 24, ...)
    model.features[0][0] = nn.Conv2d(12, 24, kernel_size=3, stride=2, padding=1, bias=False)
